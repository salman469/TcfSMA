...
public class TouchView extends View {
    ...
    private void init(Context context) {
        ...
        if (AppModel.getInstance().photoFlag == 1) {
            prefs = context.getSharedPreferences("cam_bounds" + 1, MODE_PRIVATE);
        } else if (AppModel.getInstance().photoFlag == 2) {
            prefs = context.getSharedPreferences("cam_bounds" + 2, MODE_PRIVATE);
        } else {
            prefs = context.getSharedPreferences("cam_bounds" + 3, MODE_PRIVATE);
        }
        if (prefs != null && prefs.contains("ltpx")) {
            mLeftTopPosX = prefs.getFloat("ltpx", 0);
            mLeftTopPosY = prefs.getFloat("ltpY", 0);

            mRightTopPosX = prefs.getFloat("rtpx", 0);
            mRightTopPosY = prefs.getFloat("rtpY", 0);

            mLeftBottomPosX = prefs.getFloat("lbpx", 0);
            mLeftBottomPosY = prefs.getFloat("lbpy", 0);

            mRightBottomPosX = prefs.getFloat("rbpx", 0);
            mRightBottomPosY = prefs.getFloat("rbpy", 0);
        }
        ...
        mLeftTopIcon = context.getResources().getDrawable(R.mipmap.corners);
        ...
        mRightTopIcon = context.getResources().getDrawable(R.mipmap.corners);
        ...
        mLeftBottomIcon = context.getResources().getDrawable(R.mipmap.corners);
        ...
        mRightBottomIcon = context.getResources().getDrawable(R.mipmap.corners);
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if (mRightTopBool && ((y + mCenter * 2) < mRightBottomPosY) && (x > (mLeftTopPosX + mCenter * 2))) {
                    ...
                    if (dx != 0) {
                        mRightBottomPosX = x > CameraPreview.getBtnX() - minusFactor ? mRightBottomPosX : x;
                    }
                    mRightTopPosX = x > CameraPreview.getBtnX() - minusFactor ? mRightTopPosX : x;//mPosX;
                    mRightTopPosY = y/* > CameraPreview.getBtnY() - 15 ? mRightTopPosY : y*/;//mPosY;
                ...
                if (mRightBottomBool && (y > (mLeftTopPosY + mCenter * 2)) && (x > (mLeftBottomPosX + mCenter * 2))) {
                    ...
                    if (dx != 0) {
                        mRightTopPosX = x > CameraPreview.getBtnX() - minusFactor ? mRightTopPosX : x;
                    }
                    if (dy != 0) {
                        mLeftBottomPosY = y;
                    }
                    mRightBottomPosX = x > CameraPreview.getBtnX() - minusFactor ? mRightBottomPosX : x;
                    mRightBottomPosY = y /*> CameraPreview.getBtnY() - 15 ? mRightBottomPosY : y*/;
