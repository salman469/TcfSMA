...
public class DatabaseManger extends AppCompatActivity {
...
// all global variables
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //in the below line Change the text 'yourCustomSqlHelper' with your custom sqlitehelper class name
        dbm = DatabaseHelper.getInstance(DatabaseManger.this);

        mainscrollview = new ScrollView(DatabaseManger.this);
        ...
        mainLayout = new LinearLayout(DatabaseManger.this);
        ...
        TextView secondrowtext = new TextView(DatabaseManger.this);
        ...
        tv = new TextView(DatabaseManger.this);
        tv.setTextSize(20);
        ...
        final Button submitQuery = new Button(DatabaseManger.this);
        ...
        final TextView help = new TextView(DatabaseManger.this);
        ...
        final Spinner spinnertable = new Spinner(DatabaseManger.this);
        ...
        final LinearLayout thirdrow = new LinearLayout(DatabaseManger.this);
        previous = new Button(DatabaseManger.this);
        previous.setText("Previous");

        previous.setBackgroundColor(Color.parseColor("#BAE7F6"));
        previous.setLayoutParams(secondrowlp);
        next = new Button(DatabaseManger.this);
        next.setText("Next");
        ...
        tvmessage = new TextView(DatabaseManger.this);
        ...
        final Button customQuery = new Button(DatabaseManger.this);
        ...
        ArrayAdapter<String> tablenamesadapter = new ArrayAdapter<String>(DatabaseManger.this,
        ...
        select_table.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent,
                ...
                if (pos != 0) {
                    ...
                    ArrayAdapter<String> adapter = new ArrayAdapter<String>(DatabaseManger.this,
                    ...
                    if (c2 != null) {
                        ...
                        spinnertable.setOnItemSelectedListener((new OnItemSelectedListener() {
                            ...
                            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                                    ...
                                    runOnUiThread(new Runnable() {
                                        ...
                                        public void run() {
                                            if (!isFinishing()) {
                                                ...
                                                new AlertDialog.Builder(DatabaseManger.this)
                                ...
                                if (spinnertable.getSelectedItem().toString().equals("Add row to this table")) {
                                    ...
                                    final ScrollView addrowsv = new ScrollView(DatabaseManger.this);
                                    ...
                                    final RelativeLayout addnewlayout = new RelativeLayout(DatabaseManger.this);
                                    ...
                                    for (int i = 0; i < addnewrownames.size(); i++) {
                                        ...
                                        et.setId(k);
                                        final LinearLayout ll = new LinearLayout(DatabaseManger.this);
                        ...
                        for (int k = 0; k < c2.getColumnCount(); k++) {
                            LinearLayout cell = new LinearLayout(DatabaseManger.this);
    ...
    public void updateDeletePopup(int row) {
        ...
        final RelativeLayout lp = new RelativeLayout(DatabaseManger.this);
        lp.setBackgroundColor(Color.WHITE);
        RelativeLayout.LayoutParams lay = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.WRAP_CONTENT, RelativeLayout.LayoutParams.WRAP_CONTENT);
        lay.addRule(RelativeLayout.ALIGN_PARENT_TOP);

        final ScrollView updaterowsv = new ScrollView(DatabaseManger.this);
        LinearLayout lcrud = new LinearLayout(DatabaseManger.this);
        ...
        ArrayAdapter<String> crudadapter = new ArrayAdapter<String>(DatabaseManger.this,
